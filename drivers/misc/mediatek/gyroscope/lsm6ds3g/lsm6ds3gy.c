...
#endif	
#if 1
		obj->data[LSM6DS3_AXIS_X] = (s32)(obj->data[LSM6DS3_AXIS_X]) * LSM6DS3_GYRO_SENSITIVITY_2000DPS*3142/(180*1000);
		obj->data[LSM6DS3_AXIS_Y] = (s32)(obj->data[LSM6DS3_AXIS_Y]) * LSM6DS3_GYRO_SENSITIVITY_2000DPS*3142/(180*1000);
		obj->data[LSM6DS3_AXIS_Z] = (s32)(obj->data[LSM6DS3_AXIS_Z]) * LSM6DS3_GYRO_SENSITIVITY_2000DPS*3142/(180*1000); 
...
#else
		data[LSM6DS3_AXIS_X] = (s32)(data[LSM6DS3_AXIS_X]) * LSM6DS3_GYRO_SENSITIVITY_2000DPS*3142/(180*1000*1000);
		data[LSM6DS3_AXIS_Y] = (s32)(data[LSM6DS3_AXIS_Y]) * LSM6DS3_GYRO_SENSITIVITY_2000DPS*3142/(180*1000*1000);
		data[LSM6DS3_AXIS_Z] = (s32)(data[LSM6DS3_AXIS_Z]) * LSM6DS3_GYRO_SENSITIVITY_2000DPS*3142/(180*1000*1000); 
#endif
	}
       ...
       unsigned long arg)
{
	...
	switch(cmd)
	{
		...
		case GYROSCOPE_IOCTL_SET_CALI:
			...
			{
				cali[LSM6DS3_AXIS_X] = (s32)(sensor_data.x);// * 180*1000*1000/(LSM6DS3_GYRO_SENSITIVITY_2000DPS*3142);
				cali[LSM6DS3_AXIS_Y] = (s32)(sensor_data.y);// * 180*1000*1000/(LSM6DS3_GYRO_SENSITIVITY_2000DPS*3142);
				cali[LSM6DS3_AXIS_Z] = (s32)(sensor_data.z);// * 180*1000*1000/(LSM6DS3_GYRO_SENSITIVITY_2000DPS*3142); 			
		...
		case GYROSCOPE_IOCTL_GET_CALI:
			...
			sensor_data.x = (s32)(cali[LSM6DS3_AXIS_X]);// * LSM6DS3_GYRO_SENSITIVITY_2000DPS*3142/(180*1000*1000);
			sensor_data.y = (s32)(cali[LSM6DS3_AXIS_Y]);// * LSM6DS3_GYRO_SENSITIVITY_2000DPS*3142/(180*1000*1000);
			sensor_data.z = (s32)(cali[LSM6DS3_AXIS_Z]);// * LSM6DS3_GYRO_SENSITIVITY_2000DPS*3142/(180*1000*1000); 
...
static int __init lsm6ds3_gyro_init(void)
{
	...
	if (!hw)	{
		LSM6DS3_ERR("get %s dts info fail\n", name);
		return 0;
	}
