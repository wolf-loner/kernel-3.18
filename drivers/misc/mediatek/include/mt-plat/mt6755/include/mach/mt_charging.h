...
#define BATTERY_C  (2500*100)
#define JEITA_CURRENT_DELTA      (100*100)
#define JEITA_CURRENT_0_10_MAX   (3*BATTERY_C/10)//0.3c
#define JEITA_CURRENT_10_45_MAX  (10*BATTERY_C/10)//1.0c
#define JEITA_CURRENT_45_60_MAX  (4*BATTERY_C/10)//0.4c,1000mA
#endif
