...
#if defined(ILI9881C_DSI_VDO_DIJING_HD720)
    &ili9881c_dsi_vdo_dijing_hd720_lcm_drv,
#endif
#if defined(ILI9881C_DSI_VDO_SKYWORTH_HD720)
    &ili9881c_dsi_vdo_skyworth_hd720_lcm_drv,
#endif
#if defined(TD4100_DSI_VDO_DIJING_HD720_INCELL)
    &td4100_dsi_vdo_dijing_hd720_incell_lcm_drv,
#endif
