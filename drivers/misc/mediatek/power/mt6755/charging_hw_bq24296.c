...
void charging_disable_by_ce_high(int ce_num)
{
	gpio_request(ce_num,"switch_charger_enable");	
	gpio_set_value(ce_num, 1);	
}
void charging_enable_by_ce_low(int ce_num)
{
	gpio_request(ce_num,"switch_charger_enable");	
	gpio_set_value(ce_num, 0);	
}
