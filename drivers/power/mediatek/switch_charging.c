	...
	if (current_limit != -1) {
		...
		if (current_limit < 100) {
			...
			case APPLE_0_5A_CHARGER:
				...
				break;
			default:
				chr_type_aicr = current_limit*100;
				break;
			}
			chr_type_aicr /= 100;
...
unsigned int set_bat_charging_current_limit(int current_limit)
{
	...
	if (current_limit != -1) {
		...
		case APPLE_0_5A_CHARGER:
			...
			break;
		default:
			chr_type_ichg = current_limit*100;
			break;
		}
		chr_type_ichg /= 100;
